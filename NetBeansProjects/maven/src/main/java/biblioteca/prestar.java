...
public class prestar extends javax.swing.JFrame {
    ...
    public static ArrayList <prestamos> p = new ArrayList<>();
    ...
    public prestar() {
        initComponents();
        for (libros li : registrar.l) {
            disponibles.addItem(li.getTitulo());
        }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(nombre)
                            .addComponent(id)
                            .addComponent(disponibles, 0, 130, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String lib = (String) disponibles.getSelectedItem();
        int can = Integer.parseInt(cantidad.getText());
        boolean c = true;
        
        for (int i = 0; i < p.size(); i++) {
            if (idu == p.get(i).getId()) {
                if (can > 3) {
                    JOptionPane.showMessageDialog(null, "NO PUEDES PRESTAR MÁS DE 3 LIBROS");
                }
                c = false;
            }
        ...
        p.add(new prestamos(nom, idu, lib, can));
