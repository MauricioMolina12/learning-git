...
public class Juego {
    ...
    public static void Resolver(int Vec[][]) {
        Vec[0][1] = 8;
        Vec[0][2] = 7;
        Vec[0][3] = 9;
        Vec[0][4] = 2;
...
// VERIFICAR SI LA MATRIZ TIENE 0
                    ...
                    System.out.println("Sudoku completado, Felicitaciones!");
                ...
                case 2:// MUESTRA LAS INSTRUCCIONES
                    ...
                    break;
                case 3:
                    Player1.setDificultad(gdificulty);
                    Player1.setDificultad(punt);
