...
public class NuevoUsuario extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(37, 37, 37)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(NP, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(NU, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(194, 194, 194)
                        .addComponent(RG)
                        .addGap(40, 40, 40)
    ...
    private void RGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RGActionPerformed
        ...
        String New_user = NU.getText();
        String New_pw = NP.getText();
        boolean c = true;

        for (int i = 0; i < u.size(); i++) {
            if (New_user.equals(u.get(i).getUser()) || New_pw.equalsIgnoreCase(u.get(i).getPassword())) {
                JOptionPane.showMessageDialog(null, "There is already an account with these credentials.");
                c = false;
                break;
            }
        }
        if (c) {
            u.add(new Usuarios(New_user, New_pw));
